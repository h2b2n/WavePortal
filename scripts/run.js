const main = async() => {
    ...
    const waveContract = await waveContractFacotry.deploy({
  ...
  //  await waveTxn.wait();
  //  waveTxn = await waveContract.wave("Third message!");
  //  await waveTxn.wait();

  //  waveCount = await waveContract.getTotalWaves();
  //  waveFromOwner = await waveContract.connect(randomPerson).getTotalPerson();
